...
public class GeocodingService {
    ...
    @Programmatic
    public boolean ping() {
        return lookup("Greenwich Observatory, London", 1, 1) != null;
    }
    ...
    public GeocodedAddress lookup(final String address) {
        ...
        final int socketTimeout = timeout * 1000;
        final int connectTimeout = timeout * 1000;

        return lookup(address, socketTimeout, connectTimeout);
    }

    GeocodedAddress lookup(
